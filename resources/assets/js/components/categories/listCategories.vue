                  ...
                  <tbody>
                    <tr v-for="category in categories" v-bind:class="[category.state ? 'success' : 'danger']">
                        ...
                        <td class="col-xs-2" style="text-align: center;">
                            <button class="btn" @click="editCategory(category)"><i class="fa fa-icon fa-edit"></i></button>
                            <button class="btn" @click="enableCategory(category)"><i class="fa fa-icon fa-lock"></i></button>
                            <button class="btn" @click="destroyCategory(category)"><i class="fa fa-icon fa-trash"></i></button>
                        </td>
                      </tr>
                  </tbody>
              </table>
