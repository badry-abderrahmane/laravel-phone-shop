<template>
  <div>
      ...
      <part-panel>
        <p slot="heading">Accessories List</p>
        <div slot="body">
          <div class="row">
            <div class="col-md-4">
            </div>
                      ...
                      <tbody>
                        <tr v-for="accessory in accessories">
                            ...
                            <td class="col-xs-2" style="text-align: center;">
                                <button class="btn" @click="editAccessory(accessory)" data-toggle="tooltip" title="Edit accessory"><i class="fa fa-icon fa-edit"></i></button>
                                <!-- <button class="btn" @click="enableAccessory(accessory)"><i class="fa fa-icon fa-lock"></i></button> -->
                                <button class="btn" @click="destroyAccessory(accessory)" data-toggle="tooltip" title="Delete accessory"><i class="fa fa-icon fa-trash"></i></button>
                            </td>
                          </tr>
                      </tbody>
                  </table>
