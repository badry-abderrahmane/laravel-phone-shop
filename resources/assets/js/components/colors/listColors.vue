                  ...
                  <tbody>
                    <tr v-for="color in colors">
                        ...
                        <td class="col-xs-2" style="text-align: center;">
                            <button class="btn" @click="editColor(color)"><i class="fa fa-icon fa-edit"></i></button>
                            <!-- <button class="btn" @click="enableColor(color)"><i class="fa fa-icon fa-lock"></i></button> -->
                            <button class="btn" @click="destroyColor(color)"><i class="fa fa-icon fa-trash"></i></button>
                        </td>
                      </tr>
                  </tbody>
              </table>
