                  ...
                  <tbody>
                    <tr v-for="option in options">
                        ...
                        <td class="col-xs-2" style="text-align: center;">
                            <button class="btn" @click="editOption(option)"><i class="fa fa-icon fa-edit"></i></button>
                            <!-- <button class="btn" @click="enableOption(option)"><i class="fa fa-icon fa-lock"></i></button> -->
                            <button class="btn" @click="destroyOption(option)"><i class="fa fa-icon fa-trash"></i></button>
                        </td>
                      </tr>
                  </tbody>
              </table>
