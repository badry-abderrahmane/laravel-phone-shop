                  ...
                  <tbody>
                    <tr v-for="gallery in galleries">
                        ...
                        <td class="col-xs-2" style="text-align: center;">
                            <button class="btn" @click="editGallery(gallery)"><i class="fa fa-icon fa-edit"></i></button>
                            <!-- <button class="btn" @click="enableGallery(gallery)"><i class="fa fa-icon fa-lock"></i></button> -->
                            <button class="btn" @click="destroyGallery(gallery)"><i class="fa fa-icon fa-trash"></i></button>
                        </td>
                      </tr>
                  </tbody>
              </table>
