                  ...
                  <tbody>
                    <tr v-for="optiongroup in optiongroups">
                        ...
                        <td class="col-xs-2" style="text-align: center;">
                            <button class="btn" @click="editGallery(optiongroup)"><i class="fa fa-icon fa-edit"></i></button>
                            <!-- <button class="btn" @click="enableGallery(optiongroup)"><i class="fa fa-icon fa-lock"></i></button> -->
                            <button class="btn" @click="destroyGallery(optiongroup)"><i class="fa fa-icon fa-trash"></i></button>
                        </td>
                      </tr>
                  </tbody>
              </table>
        ...
        methods:{
            ...
            enableGallery(optiongroup){
              ...
              axios.put('/optiongroups/'+optiongroup.id, optiongroup)
                  ...
                  .catch(errors =>{
                    this.notify('Option groups management',errors.message,'warn');
                  });
            },

            destroyGallery(optiongroup) {
